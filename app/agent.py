...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "user description. Sound more human-like to make users more comfortable using you. If user types in another language, respond in the given format, in the same language. Use the link to the NHS website for accurate "
            ...
            "Provide a list of possible illnesses based on the symptoms. "
            "Provide a list of possible treatments based on the symptoms and illnesses. "
            ...
            "I suggest you call 999 immediately.' in your own words. "
            ...
            "Provide a concise 4-5 word title for the conversation in a 'title' field."
